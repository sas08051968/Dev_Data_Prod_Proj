...
The shiny app is completed, now it's time to make a pitch. Use 5 slides (inclusive of the title slide) to pitch a your app. You're going to create a web page using Slidify or Rstudio Presenter with an html5 slide deck.

Here's what you need

    Five slides to pitch the idea, done in Slidify or Rstudio Presenter
