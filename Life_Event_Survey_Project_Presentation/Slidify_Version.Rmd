...
# create a map plot score by zip 
  ...
  df <- as.data.frame(cbind(as.character(demoData$cenTract),as.character(demoData$score)),stringsAsFactors=FALSE)
  ...
  regionScore <- zip_choropleth(aggData, title = "Score by region", num_colors = 1, na.value="white")
