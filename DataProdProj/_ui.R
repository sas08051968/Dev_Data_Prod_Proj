...
shinyUI(pageWithSidebar(
  headerPanel("Life Stress Survey"),
  sidebarPanel(
  ...
  mainPanel(
    ...
    p(strong("Life Event")),
    p( radioButtons(inputId="question1", label= "Death of Spouse", choices=c("No"=0, "Yes"=100), selected = 0, inline = TRUE, width = NULL)),
